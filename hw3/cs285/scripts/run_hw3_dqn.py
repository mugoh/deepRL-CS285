...
class Q_Trainer(object):
    ...
    def __init__(self, params):
        ...
        env_args = get_env_kwargs(params['env_name'], params['optm_spec_name'])
...
def main():
    ...
    # Optimizer spec for lunarlander dqn
    parser.add_argument('--optm_spec_name', '-opn',
                        default=None,
                        choices=['lander_optimizer_annealed_1',
                                 'lander_optimizer_annealed_2',
                                 'lander_optimizer_annealed_3'])
