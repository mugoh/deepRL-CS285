...
class PG_Trainer(object):
    ...
    def __init__(self, params):
        ...
        # Collect expert data
        self.params['save_expert_policy'] = self.params.pop('collect_expert_policy')
...
def main():
    ...
    parser.add_argument('--min_expert_return', '-er', type=int, default=180)
    parser.add_argument_group('--collect_expert_policy', '-cexp', type=bool, default=True)
    ...
    parser.add_argument('--video_log_freq', type=int,
                        default=-1)   # video log disabled
    parser.add_argument('--scalar_log_freq', type=int, default=1)
    # Parallelize trajectory collection
